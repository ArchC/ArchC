...
public:
   ...
   ~psc_lv()
   {
      ...
      cout << "\t[psc_lv]: Destroying " << PRINT_OBJ_STR << " TC=" << get_toggle_count() << endl;
#endif
...
#ifdef DEBUG_POWER_L1
   cout << hex << "\t" << PRINT_OBJ_STR << ": (" << (*this) << ") operator = (sc_lv " << a 
      << ") TC: " << dec << get_toggle_count() << endl;
#endif
...
#ifdef DEBUG_POWER_L1
   cout << hex << "\t" << PRINT_OBJ_STR << ": (" << (*this) << ") operator = (psc_lv " << a 
      << ") TC: " << dec << get_toggle_count() << endl;
#endif
