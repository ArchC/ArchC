...
/********************************************************/
/* parser.acasm.h: ArchC parser (acasm module)  .       */
...
/*
  It's the main acasm structure. It represents an instruction (insn) as seen by
  the acasm module.  You can think of it as an expansion of the ac_dec_instr
